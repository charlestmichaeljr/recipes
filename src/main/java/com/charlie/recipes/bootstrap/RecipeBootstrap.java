package com.charlie.recipes.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, CategoryRepository categoryRepository) {
        ...
        log.debug("Recipe Bootstrap Loaded");
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> eachUnitOfMeasure = getUnitOfMeasure("Each");
        Optional<UnitOfMeasure> tablespoonUnitOfMeasure = getUnitOfMeasure("Tablespoon");
        Optional<UnitOfMeasure> teaspoonpoonUnitOfMeasure = getUnitOfMeasure("Teaspoon");
        Optional<UnitOfMeasure> dashUnitOfMeasure = getUnitOfMeasure("Dash");
        Optional<UnitOfMeasure> cupUnitOfMeasure = getUnitOfMeasure("Cup");
        Optional<UnitOfMeasure> pinchUnitOfMeasure = getUnitOfMeasure("Pinch");
        Optional<UnitOfMeasure> pintUnitOfMeasure = getUnitOfMeasure("Pint");

        UnitOfMeasure eachUom = eachUnitOfMeasure.get();
        UnitOfMeasure tablespoonUom = tablespoonUnitOfMeasure.get();
        UnitOfMeasure teaspoonUom = teaspoonpoonUnitOfMeasure.get();
        ...
        guacRecipe.setUrl("http://cnn.com");
        ...
        guacRecipe.addIngredient(new Ingredient("fresh lime or lemon juice",new BigDecimal(5),tablespoonUom));
        guacRecipe.addIngredient(new Ingredient("minced red onions or thinly sliced green onions",new BigDecimal(2),tablespoonUom));
        guacRecipe.addIngredient(new Ingredient("serrano chilis, stems and seeds removed",new BigDecimal(2),eachUom));
        guacRecipe.addIngredient(new Ingredient("cilantro",new BigDecimal(2),tablespoonUom));
        guacRecipe.addIngredient(new Ingredient("freshly grated black pepper",new BigDecimal(2),dashUom));
        guacRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp removed, chopped",new BigDecimal(5),eachUom));

        guacRecipe.setSource("Taco Bell downtown");
        ...
        tacosRecipe.setUrl("http://msn.com");
        ...
        tacosRecipe.setSource("Sonora, Mexico");
    ...
    private Optional<UnitOfMeasure> getUnitOfMeasure(String description) {
        Optional<UnitOfMeasure> result =  unitOfMeasureRepository.findByDescriptionIgnoreCase(description);
    ...
    private Optional<Category> getCategory(String description) {
        Optional<Category> result =  categoryRepository.findByDescriptionIgnoreCase(description);
